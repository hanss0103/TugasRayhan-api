...
// BUAT ANIME RECOMENDATION

const recomen ='https://api.jikan.moe/v4/recommendations/anime'; 
...
.then((res) => {
    ...
    n.map((a) => {
        ...
        const figcaption = document.createElement('figcaption');
        const img = document.createElement('img');
        img.setAttribute('src', a.entry[0].images.jpg.image_url);
        const judul = document.createElement('h4');
        judul.innerText = a.entry[0].title;
        const judul1 = document.createElement('h4');
        judul1.innerText = a.entry[0].title;
        // const an = document.createElement('a');
        // an.setAttribute('href',a.trailer.embed_url);
        // const eps = document.createElement('h4');
        // eps.innerText = 'Episode : ' + a.episodes; 
        // const type = document.createElement('h4');
        // type.innerText = 'Type : ' + a.type;
